...
import (
	...
	"github.com/jempe/mpc/internal/jsonlog"
	"github.com/jempe/mpc/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://mpc:password@localhost/mpc?sslmode=disable", "PostgreSQL DSN")
	...
	//Site Setup
	flag.StringVar(&cfg.site.baseURL, "site-base-url", "http://localhost:4000/", "Base URL for the site")
